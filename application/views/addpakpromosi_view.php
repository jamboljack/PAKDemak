<section class="wrapper">
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                    <i class="fa fa-edit"></i> INPUT PROMOSI PEGAWAI
                    <span class="tools pull-right">
                ...
                <div class="panel-body">
                    <div class="form">
                        <form class="form-horizontal" method="post" action="<?php echo site_url('pak/savedatapromosi/'.$this->uri->segment(3)); ?>" name="form1">
                        <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">                                                    
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control m-bot15" name="lstJabatan" id="lstJabatan" required>
                                    ...
                                    {
                                    ?>
                                    <option value="<?php echo $j->kd_jabfung; ?>" <?php echo set_select('lstJabatan', $j->kd_jabfung); ?> ><?php echo $j->nm_jabfung; ?></option>
                                    <?php 
                                    }
                                    ?>
                                </select>                                
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <input class="form-control form-control-inline input-medium default-date-picker" id="tmtjabatan" name="tmtjabatan" size="16" type="text" value="<?php echo set_value('tmtjabatan'); ?>" required />
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control m-bot15" name="lstPangkat" id="lstPangkat" required>
                                    ...
                                    {
                                    ?>
                                    <option value="<?php echo $p->kd_gol; ?>" <?php echo set_select('lstPangkat', $p->kd_gol); ?> ><?php echo $p->nm_pkt.' - '.$p->nm_gol; ?></option>
                                    <?php 
                                    }
                                    ?>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <input class="form-control form-control-inline input-medium default-date-picker" id="tmtpangkat" name="tmtpangkat" size="16" type="text" value="<?php echo set_value('tmtpangkat'); ?>" required />
                            ...
                            <div class="form-group">
                                <div class="col-lg-offset-3 col-lg-6">
                                    <button class="btn btn-primary" type="submit"><span class="glyphicon glyphicon-floppy-disk"></span> Save & Finish</button>                                    
                                </div>
                            </div>
                        </form>
                    </div>
