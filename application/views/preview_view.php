...
<body>
<a href="#Print"><img src="<?php echo base_url(); ?>images/print_icon.gif" height="36" width="32" title="Print" id="print-link" onClick="window.print(); return false;" /></a>
<div class="page">
...
<table class="judul" width="100%" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td class="judul" width="43%"><b>: DINDIKPORA KAB. DEMAK</b></td>
    <td class="judul" width="50%" align="right"><b>Masa Penilaian Bulan : <?php echo tgl_indo($detail->pak_bln_1); ?> s/d <?php echo tgl_indo($detail->pak_bln_2); ?></b></td>
  </tr>
</table>
